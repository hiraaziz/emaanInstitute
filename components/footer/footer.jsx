        ...
        <div class="lg:flex lg:items-start lg:gap-8">
          ...
          <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div class="col-span-2">
              <div>
                <h2 class="text-2xl font-bold text-gray-900">Enroll Now</h2>
            ...
            duration-300 bg-pink text-white font-bold py-2 px-4 rounded w-48 "
              >
                APPLY NOW
              </button>
            </div>
            ...
            <div class="col-span-2 sm:col-span-1">
              <p class="font-bold tracking-widest text-lightpink">SERVICES</p>
            ...
            <div class="col-span-2 sm:col-span-1">
              <p class="font-bold tracking-widest text-lightpink">LEGAL</p>
